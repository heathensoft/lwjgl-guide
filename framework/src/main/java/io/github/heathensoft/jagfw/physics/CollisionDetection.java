...
public class CollisionDetection {
    ...
    public static boolean check(Body a, Body b, BodyContact contact) {
        ...
        if (a.shape instanceof Shape.Circle) {
            if (b.shape instanceof Shape.Circle) {
                return circleCircle(a,b,contact);
            } else if (b.shape instanceof Shape.PolygonShape) {
                return polygonCircle(b,a,contact);
            }
        } else if (a.shape instanceof Shape.PolygonShape) {
            if (b.shape instanceof Shape.PolygonShape) {
                return polygonPolygon(a,b,contact);
            } else if (b.shape instanceof Shape.Circle) {
    ...
    private static boolean circleCircle(Body a, Body b, BodyContact contact) {
        Shape.Circle a_shape = (Shape.Circle) a.shape;
        Shape.Circle b_shape = (Shape.Circle) b.shape;
    ...
    private static boolean polygonPolygon(Body a, Body b, BodyContact contact) {
        Shape.PolygonShape a_polygon = (Shape.PolygonShape) a.shape;
        Shape.PolygonShape b_polygon = (Shape.PolygonShape) b.shape;
    ...
    private static boolean polygonCircle(Body polygon, Body circle, BodyContact contact) {
        Shape.PolygonShape polygonShape = (Shape.PolygonShape) polygon.shape;
        Shape.Circle circleShape = (Shape.Circle) circle.shape;
    ...
    private static float findMinSeparation(Shape.PolygonShape a, Shape.PolygonShape b, Vector2f edge_normal, Vector2f point) {
    ...
    private static float findMinSeparation(Shape.PolygonShape a, Shape.PolygonShape b) {
        float separation = -Float.MAX_VALUE;
