...
import no.hio.jagfw.testing.physicsold.shape.Circle;
import no.hio.jagfw.testing.physicsold.shape.HitBox;
import no.hio.jagfw.testing.physicsold.shape.HitBoxCluster;
import no.hio.jagfw.testing.physicsold.shape.PolygonShape;
